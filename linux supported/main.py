...
def _get_app_dir() -> str:
    ...
    Windows: %LOCALAPPDATA%/vibe_agent 或当前目录
    macOS:   ~/Library/Application Support/vibe_agent
    Linux:   ~/.local/share/vibe_agent（XDG_DATA_HOME）
    """
    ...
    return os.path.join(base, "vibe_agent")
